...
const translations: Record<Language, TranslationKeys> = {
  es: {
    ...
    sl_exp1_title: 'Manantiales Serranos',
    sl_exp1_p1: 'Manantiales Serranos es una invitación a vivir Lavalleja desde sus sierras, sus aguas y su historia profunda. Un territorio único donde la naturaleza, la geología y la cultura local se transforman en una experiencia auténtica, serena y memorable.',
    sl_exp1_p2: 'Podés escuchar el agua abrirse paso entre vertientes y saltos, respirar aire puro entre monte nativo y, al caer la noche, dejarte envolver por el cielo estrellado serrano.',
    sl_exp1_li1: 'Contemplar paredones rocosos, valles y cerros antiguos del geoparque',
    sl_exp1_li2: 'Recorrer senderos, grutas, roquedales y caminos rurales',
    sl_exp1_li3: 'Explorar geositios con historias de millones de años',
    sl_exp1_li4: 'Vivir contemplación y astroturismo en la noche serrana',
    sl_exp1_cta: 'Explorar alojamientos',
    sl_exp2_badge: 'Experiencia 2',
    sl_exp2_title: 'Agua que da Vida',
    sl_exp2_p1: 'En el entorno del Parque Nacional Arequita, la naturaleza y el turismo se encuentran en armonía. A lo largo de la ribera del Río Santa Lucía, cuya naciente se ubica en Cerro Pelado, se despliega un paisaje de enorme valor ambiental, escénico y cultural. Aquí nace el agua que abastece a más de la mitad de la población del Uruguay, convirtiendo a este territorio en un espacio tan vital como memorable. En la Laguna de los Cuervos, un ensanchamiento natural del río, el paisaje se vuelve espejo y el silencio serrano invita a bajar el ritmo. En sus alrededores, diversos emprendimientos privados de alojamiento, gastronomía y actividades recreativas enriquecen la experiencia, impulsando un turismo de naturaleza auténtico, sereno y cercano. Experiencias tentativas',
    sl_exp2_li1: 'Caminatas y senderismo de baja dificultad',
    sl_exp2_li2: 'Avistamiento de aves y observación de flora nativa',
    sl_exp2_li3: 'Picnic y descanso frente río',
    sl_exp2_li4: 'Fotografía de paisajes y atardeceres serranos',
